...
More recently, practical toolchains such as libsnark~\cite{bensasson2014vn}, Halo2~\cite{halo2}, and EzKL~\cite{ezkl} have enabled developers to compile high-level programs and machine learning models into circuits suitable for zk-SNARK proving.
...
\newblock Halo2: A PLONK-based zero-knowledge proving system.
\newblock Available at: \url{https://github.com/zcash/halo2}

\bibitem{ezkl}
Zkonduit.
\newblock EzKL: Zero-Knowledge Machine Learning Framework.
\newblock Available at: \url{https://github.com/zkonduit/ezkl}
